package com.imooc.wechat.demowechart.test;
...
public class TestWx {
	...
	public void testGetUserInfo() {
		...
		String info = WxTokeService.getUserInfo(user);
	...
	public void testButton() {
		...
		// 转为json
		JSONObject jsonObject = JSONObject.parseObject(JSONObject.toJSONString(btn));
